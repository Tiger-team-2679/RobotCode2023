...
public final class ArmConstants {
  ...
  public static final int MOTOR_ELBOW_ID = 0;
  ...
  public static final double ANGLE_FEEDER_SHOULDER = 0, ANGLE_FEEDER_ELBOW = 0;
  public static final double ANGLE_THIRD_SHOULDER = 100, ANGLE_THIRD_ELBOW = 100;
  public static final double ANGLE_SECOND_SHOULDER = 85, ANGLE_SECOND_ELBOW = 85;
  public static final double ANGLE_FIRST_SHOULDER = 40, ANGLE_FIRST_ELBOW = 40;
